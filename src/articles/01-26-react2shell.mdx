export const metadata = {
  ...
  seoDescription:
    'CVE-2025-55182 turned a single HTTP request into a server shell. Learn how the React Flight protocol flaw works and how a proactive patching mindset defends you.',
  image:
