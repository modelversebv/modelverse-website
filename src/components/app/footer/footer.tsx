...
export function Footer({ onManagePrivacy }: FooterProps) {
  ...
  return (
    <div className="mt-16 h-fit w-full border-t bg-black/70">
      <div className="flex flex-col items-center-safe justify-center-safe gap-2 bg-white/10 p-4 text-center backdrop-blur-md">
