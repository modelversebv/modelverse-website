  ...
  <Hero>
    <div className="flex flex-col items-center-safe gap-8 lg:basis-1/2 lg:justify-center-safe">
      <div className="flex flex-col items-center-safe gap-4 text-center">
        ...
        <p className="text-lg">
          Have questions about Modelverse? Our team is here to help. Reach out
      ...
      <div className="bg-gray-50">
        <div className="flex flex-col justify-center-safe gap-8 px-4 py-16 md:container md:mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <img
              src="/images/misc/hsd_campus.jpg"
              alt=""
      ...
      <div className="flex flex-col gap-8 px-4 py-16 md:container md:mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Card className="gap-4">
            ...
            <p>
              Yes! We provide customized demos tailored to your organization's
              specific needs and use cases. Simply select "Request a Demo" in
              the inquiry type above.
            </p>
          </Card>
          <Card className="gap-4">
            <h1 className="text-lg">
            ...
            <p>
              Absolutely. After submitting the form, our sales team will reach
              out to schedule a convenient time for a call or video meeting.
            </p>
          </Card>
        </div>
      </div>
