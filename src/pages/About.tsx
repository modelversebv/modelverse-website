...
export function AboutPage() {
  ...
  const ambassadors = [
    ...
    },
    {
      ...
      bio: 'Alexandra Roger-Machart is a forward-thinking senior professional with deep industry experience in the Renewable Energy and Consumer Goods sectors. Specializing in Communications and Corporate Disclosures, Alexandra helps companies strengthen their external profile, engage with stakeholders and enhance their corporate reporting through both strategic storytelling and regulatory expertise. Having worked across various organizational dynamics, from fast-growing startups to large blue-chip corporations such as Unilever, her background spans B2B, B2C and B2G environments. Her expertise covers Corporate and Financial Communications, Sustainability Reporting, Investor Relations, Crisis PR and Media Engagement. Passionate about Tech and AI-driven transformation, Alexandra advises startups and scaleups, bringing a customer-centric, interdisciplinary perspective and a global outlook with fluency in German, English, French and Dutch..',
