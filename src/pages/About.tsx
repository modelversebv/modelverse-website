      ...
      <div className="bg-gray-50">
        <div className="flex flex-col justify-center-safe gap-8 px-4 py-16 md:container md:mx-auto">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="flex flex-col gap-4 md:justify-center-safe">
              ...
              <p>
                ...
                talent. Meanwhile, enterprise security solutions were either too
                expensive, too complex, or simply not designed for organizations
              ...
              <p>
                ...
                security to organizations of all sizes, with the simplicity and
                affordability that growing businesses need.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 text-center">
            ...
            <p>The principles that guide everything we do at Modelverse.</p>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {values.map((value, index) => (
                <Card key={index} className="justify-center-safe text-left">
          ...
          <div className="flex flex-col gap-4 text-center">
            ...
            <p>The passionate people behind Modelverse.</p>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col px-4 py-8">
                    ...
                    <h1 className="mb-4 text-lg text-amber-500">
                      {member.role}
                    </h1>
                    <p>{member.bio}</p>
                  </div>
