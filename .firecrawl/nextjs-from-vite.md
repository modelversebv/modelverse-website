...
## Why Switch? [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#why-switch)

There are several reasons why you might want to switch from Vite to Next.js:

### Slow initial page loading time [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#slow-initial-page-loading-time)
...
### No automatic code splitting [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#no-automatic-code-splitting)
...
### Network waterfalls [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#network-waterfalls)
...
### Fast and intentional loading states [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#fast-and-intentional-loading-states)
...
### Choose the data fetching strategy [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#choose-the-data-fetching-strategy)
...
### Proxy [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#proxy)
...
### Built-in Optimizations [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#built-in-optimizations)
...
## Migration Steps [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#migration-steps)
...
### Step 1: Install the Next.js Dependency [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-1-install-the-nextjs-dependency)
...
### Step 2: Create the Next.js Configuration File [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-2-create-the-nextjs-configuration-file)
...
### Step 3: Update TypeScript Configuration [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-3-update-typescript-configuration)
...
### Step 4: Create the Root Layout [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-4-create-the-root-layout)
...
5. Any [metadata files](https://nextjs.org/docs/app/getting-started/metadata-and-og-images#file-based-metadata)
...
### Step 5: Create the Entrypoint Page [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-5-create-the-entrypoint-page)
...
### Step 6: Update Static Image Imports [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-6-update-static-image-imports)
...
### Step 7: Migrate the Environment Variables [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-7-migrate-the-environment-variables)
...
### Step 8: Update Scripts in `package.json` [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-8-update-scripts-in-packagejson)
...
### Step 9: Clean Up [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#step-9-clean-up)
...
## Next Steps [Link to this section](https://nextjs.org/docs/app/guides/migrating/from-vite\#next-steps)
